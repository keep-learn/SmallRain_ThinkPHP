...
<div id="container" style="background:url('<?php echo (IMG_URL); ?>login_bg.jpg');
	...
	<div class="row">
		<div class="col-md-6 col-sm-6 col-xs-6  col-md-offset-3 col-sm-offset-3 col-xs-offset-3" style="margin-top:100px;background:white;padding:30px;padding-bottom:60px;" >
		<h2 class="text-center">登录界面</h2>
			
				用户名 : <input id="username" type="text" class="form-control" name="username" /> <br/>
						<p class="alert_font alert_name">填写 : 用户名以字母开头的,数字字母下划线组合</p> 					
				<br/>
				密 码  : <input id="passwd" type="password" class="form-control" name="passwd" /><br/>
						<p class="alert_font alert_passwd">亲 , 请输入密码</p>
				<br/>
